...
// no per-row Dismiss — Save/Pass now live in the opportunity-detail screen's decision block (#100,
// per the mockup's own DetailView), so opening a row is this component's only affordance.
//
// Still pure presentation, same discipline as before: board.tsx owns the fetch/sort/select
// decision, this file only renders one `BoardMatch` it's handed and calls back through `onOpen`.
