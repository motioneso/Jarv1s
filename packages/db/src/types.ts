...
export type PersonContextIdentityStatusDb =
  ...
  | "rejected"
  | "split";
export type PersonContextProvenanceDb =
  | "source"
  | "inferred"
  | "user_confirmed"
  | "imported";
...
export interface PersonContextPeopleTable {
  ...
  status: ColumnType<PersonContextStatusDb, PersonContextStatusDb | undefined, PersonContextStatusDb>;
...
export interface PersonContextIdentitiesTable {
  ...
  status: ColumnType<PersonContextIdentityStatusDb, PersonContextIdentityStatusDb | undefined, PersonContextIdentityStatusDb>;
  confidence: ColumnType<number, number | undefined, number>;
  provenance: ColumnType<PersonContextProvenanceDb, PersonContextProvenanceDb | undefined, PersonContextProvenanceDb>;
  first_seen_at: TimestampColumn;
  last_seen_at: TimestampColumn;
  created_at: TimestampColumn;
  updated_at: TimestampColumn;
...
export interface PersonContextMatchCandidatesTable {
  ...
  status: ColumnType<PersonContextCandidateStatusDb, PersonContextCandidateStatusDb | undefined, PersonContextCandidateStatusDb>;
