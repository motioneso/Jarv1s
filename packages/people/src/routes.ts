...
export function registerPeopleRoutes(app: FastifyInstance, deps: PeopleRouteDependencies): void {
  ...
  app.get("/api/people/match-candidates", { schema: { response: { 200: Type.Any() } } }, async (request) => {
    const ac = await deps.resolveAccessContext(request);
    return deps.dataContext.withDataContext(ac, async (sdb) => {
  ...
  app.post("/api/people/match-candidates/:id/accept", { schema: { response: { 200: Type.Any() } } }, async (request) => {
    const ac = await deps.resolveAccessContext(request);
  ...
  app.post("/api/people/match-candidates/:id/reject", { schema: { response: { 200: Type.Any() } } }, async (request) => {
    const ac = await deps.resolveAccessContext(request);
    const { id } = request.params as { id: string };
    return deps.dataContext.withDataContext(ac, async (sdb) => {
  ...
  app.post("/api/people/match-candidates/:id/suppress", { schema: { response: { 200: Type.Any() } } }, async (request) => {
    const ac = await deps.resolveAccessContext(request);
    const { id } = request.params as { id: string };
    return deps.dataContext.withDataContext(ac, async (sdb) => {
  ...
  app.post("/api/people/index/refresh", { schema: { body: refreshSchema } }, async (request, reply) => {
    const ac = await deps.resolveAccessContext(request);
  ...
  app.get("/api/people/:id/links", { schema: { response: { 200: Type.Any() } } }, async (request) => {
    const ac = await deps.resolveAccessContext(request);
    const { id } = request.params as { id: string };
  ...
  app.patch("/api/people/:id", { schema: { body: updateSchema, response: { 200: Type.Any() } } }, async (request) => {
    const ac = await deps.resolveAccessContext(request);
    const { id } = request.params as { id: string };
  ...
  app.post("/api/people/:id/archive", { schema: { response: { 200: Type.Any() } } }, async (request) => {
    const ac = await deps.resolveAccessContext(request);
    const { id } = request.params as { id: string };
    return deps.dataContext.withDataContext(ac, async (sdb) => {
  ...
  app.post("/api/people/:id/merge", { schema: { body: mergeSchema, response: { 200: Type.Any() } } }, async (request) => {
    const ac = await deps.resolveAccessContext(request);
    const { id } = request.params as { id: string };
  ...
  app.post("/api/people/:id/split-identity", { schema: { body: splitSchema, response: { 200: Type.Any() } } }, async (request) => {
    const ac = await deps.resolveAccessContext(request);
