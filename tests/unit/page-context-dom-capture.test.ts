...
// page-context imports app-route-metadata, which reaches `virtual:jarvis-module-web`. Under jsdom
// that chain dies on the vitest.config `@jarv1s/news` alias, which prefix-matches `@jarv1s/news/web`
