...
**Worktree:** /home/ben/Jarv1s/.claude/worktrees/backlog-82-tabular-results **Branch:** backlog-82-tabular-results (off origin/main)
...
- Work only in this worktree/branch. `git add` only your files. `Co-Authored-By: Claude Sonnet 4.6`
