...
**Worktree:** /home/ben/Jarv1s/.claude/worktrees/audit-slice-c **Branch:** audit-slice-c (off origin/main @ d186e01)
...
- Work **only** in this worktree (`/home/ben/Jarv1s/.claude/worktrees/audit-slice-c`). Never touch the shared main tree.
