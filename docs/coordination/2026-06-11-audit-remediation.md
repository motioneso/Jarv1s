...
**merges_since_relay:** 1 — B #187 MERGED (security tier) 2026-06-12T05:08:59Z by p_44 → **RELAY FIRING NOW** (security-tier merge = unconditional relay). \_History: F #184 04:34Z, G #186 + I #185 ~04:40Z under p_38; B #187 05:09Z under p_44.*
...
Lock NOW: Coordinator = `$HERDR_PANE_ID=<successor's own — set on claim>` (replaces p_44, pane volatile).
