...
**merges_since_relay:** 1 (#253/#330 SECURITY `66c2cba`) — **RELAY DUE** (security merge). Successor resets to 0 on adoption.
**last_alive:** 2026-06-19T16:28Z (Codex coordinator `019ee077…`; #253/#330 MERGED `66c2cba`; #306 still blocked on missing `JARVIS_IMAGE_TAG`; relay due now)
