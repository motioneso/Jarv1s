...
**merges_since_relay:** 1 (#218/#328 SECURITY `f8272679`) — **RELAY DUE** (security merge). Successor resets to 0 on adoption.
**last_alive:** 2026-06-19T08:40Z (Codex coordinator `019eded5…`; #218/#328 MERGED `f8272679`; #306 still blocked on missing `JARVIS_IMAGE_TAG`; relay due now)
