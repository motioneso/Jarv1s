...
| `docs/superpowers/specs/2026-06-18-ai-provider-test-and-model-detect.md`            | #252  | security  | building: started after #306 blocked; awaiting build plan                                                                                 | Build-252-AIProviderTest  | —      | phase2-252-ai-provider-test-model-detect | —    |
