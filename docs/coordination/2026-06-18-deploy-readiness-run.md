...
**merges_since_relay:** 1 (#252/#329 SECURITY `3e526d1`) — **RELAY DUE** (security merge). Successor resets to 0 on adoption.
**last_alive:** 2026-06-19T15:18Z (Codex coordinator `019edf08…`; #252/#329 MERGED `3e526d1`; #306 still blocked on missing `JARVIS_IMAGE_TAG`; relay due now)
