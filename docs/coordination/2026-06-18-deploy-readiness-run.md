...
| `docs/superpowers/specs/2026-06-18-ai-provider-test-and-model-detect.md`            | #252  | security  | qa: PR #329; GLM + Gemini review running; independent gate running                                                                         | Build-252-AIProviderTest  | w1:p37 | phase2-252-ai-provider-test-model-detect | #329 |
