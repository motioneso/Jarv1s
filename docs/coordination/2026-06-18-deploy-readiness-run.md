...
**merges_since_relay:** 2 (sensitive merges #336/#151 and #335/#238; relay now)
**last_alive:** 2026-06-19T22:40Z (Codex `019ee1c8…`; relaying after #335 merge)
...
- No live build/QA fleet at relay time.
- **#239 account self-deletion** — **UNBLOCKED**, dispatch after successor adoption (shared `packages/settings`). SECURITY tier. Spec `docs/superpowers/specs/2026-06-19-account-self-deletion.md`. LOCKED: hard-block bootstrap-owner self-delete; **HARD DELETE no grace period — FLAGGED to Ben for possible override**; audit `user.delete.self`.
