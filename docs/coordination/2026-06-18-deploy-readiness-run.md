...
| `docs/superpowers/specs/2026-06-18-otnr-p2-secrets-vault-residuals.md`              | #114  | security  | **BEN SIGN-OFF GIVEN 2026-06-19** (flaky RED judged Codex usage-window-related). GLM GREEN @ current head `27972b7`. PLAN: after #254 merges, run clean Claude gate-runner (rebase on `origin/main`); if GREEN → MERGE. | Build-114-SecretResiduals | w1:p2G | deploy-114-secret-residuals | #321 |
