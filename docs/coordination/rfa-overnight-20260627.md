...
| #531 | `docs/superpowers/specs/2026-06-27-restrained-proactive-monitoring.md` | security | PR #563 CI 3/4 green on `168aeb95`; round-4 dual QA IN FLIGHT: QA-563-R4-Opus (native Opus Agent) + QA-563-AGY-R4 (w1:p57); ⚠️ failure-budget=2 note for relay | Claude Sonnet | QA-563-R4-Opus + QA-563-AGY-R4 (w1:p57) in-flight | `rfa-531-proactive-monitoring` | #563 |
| #535 | `docs/superpowers/specs/2026-06-27-long-running-jarvis-goals.md` | security | PR #566 CI 3/4 green on `2af4ede5`; dual QA IN FLIGHT: QA-566-Opus (native Opus Agent) + QA-566-AGY (w1:p58); merge AFTER #531 lands | AGY | QA-566-Opus + QA-566-AGY (w1:p58) in-flight | `rfa-535-long-running-goals` | #566 |
