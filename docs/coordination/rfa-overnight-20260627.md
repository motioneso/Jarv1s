...
| #541 | `docs/superpowers/specs/2026-06-28-data-freshness-visibility.md` | routine | **BUILDING** — R2 writing relay doc + compacting. R3 expected. Collision note: shares chat-api.ts with #539 (disjoint fields). | Claude/Sonnet | Sonnet QA (TBD) | `rfa-541-data-freshness-visibility` | - |
