...
| #538 | `docs/superpowers/specs/2026-06-27-unified-person-contact-model.md` | security | **MERGED ✅** — PR #574 squash-merged @ db4c8cf4. Migration slot 0128. Dual QA: Opus GREEN (10/10 security invariants) + GLM GREEN. Issue #538 closed. Board → Done. Worktree + panes pending reap (successor). Advisory: service.ts 2 direct Kysely queries (RLS-safe, follow-up). | Claude/Sonnet | Opus GREEN + GLM GREEN | `rfa-538-person-contact-model` | #574 ✅ |
...
| #540 | `docs/superpowers/specs/2026-06-28-safe-automation-audit-log.md` | sensitive | **MERGED ✅** — PR #573 squash-merged @ 1bf909d8. Migration slot 0127. Dual QA: Codex inv:pass + GLM GREEN. Issue #540 closed. Board → Done. Worktree removed. | Claude/Sonnet | Codex inv:pass + GLM GREEN | `rfa-540-safe-automation-audit-log` | #573 ✅ |
