...
| #538 | `docs/superpowers/specs/2026-06-27-unified-person-contact-model.md` | security | **BUILDING** — R2 (Sonnet, w1:p61, session 877d7818). R1 reaped 2026-06-28. Writing plan now. Plan NOT yet approved. Migration slot: 0127 (use XXXX placeholder). | Claude/Sonnet | Codex+GLM dual security QA (TBD) | `rfa-538-person-contact-model` | - |
...
| #539 | `docs/superpowers/specs/2026-06-28-source-backed-answers-provenance.md` | sensitive | **QA IN PROGRESS** — PR #571 open. VF_EXIT=0 AUDIT_EXIT=0 (1190 pass/2 skip/92 files). Dual QA spawned: Codex (w1:p67) + GLM (w1:p68). Awaiting both verdicts. Collision: #541 touches chat-api.ts (disjoint; second to merge needs rebase). | Claude/Sonnet | Codex (w1:p67) + GLM (w1:p68) — IN PROGRESS | `rfa-539-source-backed-provenance` | #571 |
