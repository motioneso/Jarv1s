...
| #531 | `docs/superpowers/specs/2026-06-27-restrained-proactive-monitoring.md` | security | PR #563 CI 4/4 GREEN on fix head `7ddc08a61a39`; dual-model QA IN PROGRESS — Codex (w1:p53) + Gemini AGY (w1:p52) | Claude Sonnet | QA-563-Codex w1:p53 + QA-563-GLM w1:p52 running; both must GREEN before merge | `rfa-531-proactive-monitoring` | #563 |
