...
| #531 | `docs/superpowers/specs/2026-06-27-restrained-proactive-monitoring.md` | security | PR #563 CI 3/4 green on head `6b0ba309` (image build pending, expected); round-3 dual QA IN FLIGHT: Opus native subagent QA-563-R3-Opus + AGY pane w1:p56 QA-563-AGY-R3 | Claude Sonnet | QA-563-R3-Opus (native Opus) + QA-563-AGY-R3 (w1:p56 AGY) both in-flight | `rfa-531-proactive-monitoring` | #563 |
