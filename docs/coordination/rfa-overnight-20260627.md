...
| #531 | `docs/superpowers/specs/2026-06-27-restrained-proactive-monitoring.md` | security | PR #563 QA RED (Codex round 2) — 2 blockers: (1) msg.subject unsanitized in monitor-provider.ts:78; (2) signal/result association lost in scanner.ts:160-167 after sort. FIX-531-2 agent w1:p54 fixing both. AGY QA still running (w1:p52). | Claude Sonnet | QA-563-GLM w1:p52 still running; FIX-531-2 w1:p54 addressing Codex blockers | `rfa-531-proactive-monitoring` | #563 |
