...
| #535 | `docs/superpowers/specs/2026-06-27-long-running-jarvis-goals.md` | security | PR #566 OPEN head `6b9f9468` — CI RED (all 3 fail at 17s at "Install dependencies"; pnpm install broken); AGY (w1:p4X) fixing | AGY | dual-model QA pending after CI green | `rfa-535-long-running-goals` | #566 |
