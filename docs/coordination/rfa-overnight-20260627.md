...
| #531 | `docs/superpowers/specs/2026-06-27-restrained-proactive-monitoring.md` | security | PR #563 CI IN_PROGRESS on head `6b0ba309` — FIX-531-2 done (subject sanitization + scanner sort-pairing fixed; gates green format/lint/typecheck); AGY round-2 verdict GREEN (pre-fix head); round-3 dual QA (Codex+AGY) pending CI green | Claude Sonnet | round-3 Codex+AGY QA pending after CI green on 6b0ba309 | `rfa-531-proactive-monitoring` | #563 |
