...
**merges_since_relay:** 1 (security-tier merge PR #566; Ben instructed NO relay on auto-compaction 2026-06-28)
...
| #537 | `docs/superpowers/specs/2026-06-27-automatic-commitment-extraction.md` | security | **BUILDING** — RFA-537 Claude (Sonnet, w1:p5G), worktree rfa-537-commitment-extraction, off d9b798c5. Migration slot: 0125 | Claude/Sonnet | Opus+AGY security QA (TBD) | `rfa-537-commitment-extraction` | - |
...
| #557 | `docs/superpowers/specs/2026-06-28-calendar-delete-tool.md` | security | **BUILDING** — RFA-557 Claude (Sonnet, w1:p5H), worktree rfa-557-calendar-delete, off d9b798c5. Migration slot: 0126 | Claude/Sonnet | Opus+AGY security QA (TBD) | `rfa-557-calendar-delete` | - |
