...
| #526 | `docs/superpowers/specs/2026-06-27-unified-priority-model.md` | sensitive | plan approved; building (`w1:p3M`) | opencode/GLM | AGY QA | `rfa-526-unified-priority-model` | - |
