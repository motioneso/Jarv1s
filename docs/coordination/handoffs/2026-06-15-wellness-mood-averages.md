...
**Worktree:** ~/Jarv1s/.claude/worktrees/wellness-mood-averages **Branch:** wellness-mood-averages (off origin/main @ f6c47ce)
**Build skill path (absolute):** ~/Jarv1s/.claude/worktrees/wellness-mood-averages/.claude/skills/coordinated-build/SKILL.md
