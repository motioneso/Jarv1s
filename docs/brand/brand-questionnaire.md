...
6. What personality traits should users be able to tune?
...
15. What kinds of interests belong in the briefing?
    - news
    - sports
    - hobbies
    - local events
...
16. What question should the daily briefing answer?

17. What should the briefing never become?
    - generic dashboard
    - chatbot transcript
    - noisy feed reader
    - therapy journal
...
18. What should the user feel after reading the morning briefing?

19. What should the user feel after using tomorrow prep?
...
24. Which visual metaphor should lead?
...
26. Where should delight appear?
    - copy
    - empty states
    - transitions
    - briefing sign-offs
    - user-persona-specific moments
...
- Accountability should never become judgment.
