...
- `claude` → `/home/ben/.local/bin/claude` — **AVAILABLE**, version **2.1.168 (Claude Code)**.
...
| --- | --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------- |
| 1   | Binary on PATH?                   | **YES** `/home/ben/.local/bin/claude`, v2.1.168                                                                                                                                                                                                         | **NO — UNAVAILABLE, verify later**                                                                                                                | **NO — UNAVAILABLE, verify later**                                                                       |
