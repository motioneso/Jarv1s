...
- `Co-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>` trailer on every commit
...
- [ ] All commits have `Co-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>` trailer
