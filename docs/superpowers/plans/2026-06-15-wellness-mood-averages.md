...
```bash
cd /home/ben/Jarv1s/.claude/worktrees/wellness-mood-averages && pnpm typecheck 2>&1 | tail -10
```
...
```bash
cd /home/ben/Jarv1s/.claude/worktrees/wellness-mood-averages && pnpm exec prettier --write apps/web/src/styles/wellness-2.css
```
...
```bash
cd /home/ben/Jarv1s/.claude/worktrees/wellness-mood-averages && pnpm format:check && pnpm lint && pnpm typecheck
```
...
```bash
cd /home/ben/Jarv1s/.claude/worktrees/wellness-mood-averages && pnpm verify:foundation
```
