...
```bash
cd ~/Jarv1s/.claude/worktrees/backlog-82-tabular-results
...
The spec exists in the main worktree at `~/Jarv1s/docs/superpowers/specs/2026-06-09-backlog-82-compact-tabular-tool-results.md` but is not yet in this worktree's branch. Copy it:

```bash
cp ~/Jarv1s/docs/superpowers/specs/2026-06-09-backlog-82-compact-tabular-tool-results.md \
