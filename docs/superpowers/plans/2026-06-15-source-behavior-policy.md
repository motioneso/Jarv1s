...
git commit -m "docs(spec): restore source behavior policy spec" -m "Co-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>"
```
...
git commit -m "feat(source-behaviors): add manifest-driven policy helper" -m "Co-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>"
```
...
git commit -m "feat(modules): declare source behaviors in manifests" -m "Co-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>"
```
...
git commit -m "feat(settings): expose per-user source behavior policy" -m "Co-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>"
```
...
git commit -m "feat(briefings): honor source behavior policy" -m "Co-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>"
```
...
git commit -m "feat(web): wire source behavior controls to API" -m "Co-Authored-By: Claude Sonnet 4.6 <noreply@anthropic.com>"
```
