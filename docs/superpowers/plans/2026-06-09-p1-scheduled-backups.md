...
# Optional: override Obsidian vault location (default: ~/obsidian-vault)
# JARVIS_VAULT_DIR=~/obsidian-vault
...
```bash
cd ~/Jarv1s/.claude/worktrees/p1-scheduled-backups
...
#   Snapshotting vault: ~/obsidian-vault
...
EnvironmentFile=~/Jarv1s/infra/backup.env
