...
Use `~/Jarv1s/.claude/skills/coordinated-wrap-up/SKILL.md`: run full gate/audit, push `chat-model-override-241`, open PR against `main`, and report PR + evidence to Coordinator. Do not move board, merge, or edit `docs/coordination/`.
