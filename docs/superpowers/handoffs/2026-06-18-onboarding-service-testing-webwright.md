...
- Webwright is installed for Codex:
  ...
  - Skill cache: `/home/ben/.codex/plugins/cache/webwright/webwright/0.1.0/skills/webwright/SKILL.md`
  - Runtime command: `/home/ben/.local/bin/webwright`
...
- `/home/ben/.codex/sessions/2026/06/17/rollout-2026-06-17T21-58-01-019ed917-e22f-7893-889e-0f6b069bbf15.jsonl`
...
- `/home/ben/.gemini/tmp/jarv1s-provider-check-s9iwyp/logs.json` with `[]`
- `/home/ben/.gemini/state.json`
- `/home/ben/.gemini/oauth_creds.json`
- `/home/ben/.gemini/projects.json`
- `/home/ben/.gemini/.project_root`
...
1. Inspect newest provider-check transcript and this session's transcript list:
   ...
   ```bash
   ls -lt /home/ben/.codex/sessions/2026/06/17/*.jsonl | head -20
   tail -n 80 /home/ben/.codex/sessions/2026/06/17/rollout-2026-06-17T21-58-01-019ed917-e22f-7893-889e-0f6b069bbf15.jsonl
   ```
...
1. Inspect recursive Gemini tmp output:
   ...
   ```bash
   find /home/ben/.gemini -maxdepth 6 -type f -printf '%T@ %p\n' | sort -nr | head -80
   ```
