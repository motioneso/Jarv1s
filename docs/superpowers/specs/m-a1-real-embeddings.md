...
export class StubEmbeddingProvider implements EmbeddingProvider {
  ...
  async embedDocument(text: string): Promise<number[]> { return this.hashEmbed(text); }
  async embedQuery(text: string): Promise<number[]>    { return this.hashEmbed(text); }

  private hashEmbed(text: string): number[] { /* existing SHA-256 logic */ }
}
```
