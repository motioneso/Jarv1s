...
Exercise News Settings on exact pushed head `36a0639433a2cbb592716d2df21931fb7f63160b` through the real Vite-served app shell and real News Settings UI, with deterministic browser-intercepted API responses. Capture durable desktop and narrow evidence for add/edit/remove, empty state, actionable validation failure with retained input, and retry-validation queued/error feedback.
